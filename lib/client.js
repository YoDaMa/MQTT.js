...
function sendPacket (client, packet, cb) {
  ...
  if (!result && cb) {
    debug('sendPacket :: stream is not draining, wait for currently buffered chunks to be accepted by OS.')
...
function MqttClient (streamBuilder, options) {
  ...
  this.on('close', function () {
    debug('close :: setting connected to `false`')
    this.connected = false
...
MqttClient.prototype._setupStream = function () {
  ...
  this.stream.on('close', function () {
    ...
    debug('stream :: close :: emit close to MqttClient')
    that.emit('close')
  })
...
MqttClient.prototype._handleConnack = function (packet) {
  ...
  debug('_handleConnack :: clearing connackTimer')
  clearTimeout(this.connackTimer)
